...
* **S. Gupta**\*, R. D. Yadav\*, A. Sharma, S. Roy, S. Baldi, and W. Pan, "A switched adaptive control framework for aerial manipulators under dynamic transitions," *IEEE Transactions on Robotics*, **under review**.  
...
* **S. Gupta**\*, S. Mishra\*, A. Mittal, A. Ayub, K. Farooque, S. Roy, and B. Gupta, "Bab\_Sak Robotic Intubation System (BRIS): A novel endotracheal intubation system with an integrated monocular carinal measurement module," *IEEE Transactions on Medical Robotics and Bionics*, **under review**.  
...
---
* A. Sharma, **S. Gupta**, S. P. Singh, R. D. Yadav, H. Song, W. Pan, S. Roy, and S. Baldi, "Impedance and stability targeted adaptation for aerial manipulator with unknown coupling dynamics," *IEEE International Conference on Control, Automation and Systems (ICCAS)*, **Accepted(preprint)**.  
...
---
* **S. Gupta**, A. Sharma, A. Mulgundkar, R. D. Yadav, and S. Roy, "Adaptive Control of Quadrotor under Actuator Loss and Unknown State-dependent Dynamics," *2024 IEEE 20th International Conference on Automation Science and Engineering (CASE)*, Bari, Italy, 2024, pp. 717–722.  
